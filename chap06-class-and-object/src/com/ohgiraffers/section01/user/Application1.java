...
public class Application1 {
    public static void main(String[] args) {
        ...
        //사용자 정의 자료형 사용하기
        //변수 선언및 객체 생성
        //클래스명 변수명 = new 클래스명 (); <-- 지금까지 사용했던 이 구문은 객체 (instance)를 생성하는 구문임
        //객체를 생성하게 되면 클래스에 정의한 필드와 메소드 대로 객체(instance)가 생성된다
        Member member = new Member();

        //이렇게 객체를 생성하면 서로 다른 자료형을 member라는 하나의 이름으로 관리할수 있느도록 공간을 생성한 것이다ㅣ
        //heap에 생성되므로 기본 값으로 초기화된다

        //필드에 접근하기 위해서는 레퍼런스변수며ㅇ, 필드면 으로 접근함
        // '.'은 참조 연산자라고 하는데 레퍼런스 변수가 참조하는 주소로 접근한다는 의미를 가짐
