...
public class A_for {
    ...
    public void testForExamplel() {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            System.out.println(i + "번째의 이름은 " + student + " 입니다.");
        }
    }
    ...
    public void testForExample3() {
        //5~10 사이의 난수를 발생시켜 1부터 발생한 난수까지의 합계를 구한다.
    ...
    public void testForExample4(){
        //숫자 두개를 입력 받아 작은 수 에서 큰 수까지의 합계를 구하세요
       ...
       //작은 수에서 시작해서 큰 수까지의 합계를 구하는 것이라서
       //first와 second 중 어느것이 큰 수인지를 확인하면 작은수 ~큰수까지의 합계를 구하는 로직으로 작성 가능
       int min = 0;
       int max = 0;
    ...
    public void printSimpleGugudan(){
        //구구단은 곱하는 수가 1부터 시작하여 9까지 1씩 증가, 곱하는 규칙이 있다

        //키보드로 2 ~9 사이릐 수를 입력받아 구구단을 출력하고
        //해당 범위릐 수를 입력하지 ㅏㅇㄶ으면 "반드시 2~9 사이의 양수를 입력해야 합니다" 를 출력한다
        Scanner sc = new Scanner(System.in);
