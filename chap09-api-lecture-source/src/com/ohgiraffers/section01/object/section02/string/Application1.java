...
public class Application1 {
    public static void main(String[] args) {
        //String 클래스의 자주 사용하는 메소드에 대해 숙지하고 응용하기
        /* charAt() */
        String str1 = "apple";
        ...
        /* compareTo() : 인자로 전달된 문자열과 사전 순으로 비교를 하여 두 문자열이 같으면 0,
        인자로 전달된 문자열보다 작으면 음수, 인자로 전달된 문자열보다 크면 양수로 반환함*/
        String str2 = "java";
        String str3 = "java";
        String str4 = "JAVA";
        String str5 = "oracle";
//----------------------------------
        ...
        String str6 = "java";
        String str7 = "oracle";
        System.out.println("concat() : " + (str1.concat(str7))); //javaoracle
        System.out.println("str1 : " + str6);

        //-----------------------------------------

        /* indexOf() : 문자열에서 특정 문자를 탐색하여 처음 일치하는 !인덱스 위치!를 정수형으로 반환한다.
